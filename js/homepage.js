...
new ScrollMagic.Scene({
    triggerElement: "#futsal_app",
    reverse: false
  })
  .setClassToggle("#futsal_app", "loaded") // add class toggle
  .addTo(controller);
...
new ScrollMagic.Scene({
  ...
  .setClassToggle("#internship", "loaded") // add class toggle
  .addTo(controller);

    new ScrollMagic.Scene({
      triggerElement: "#dinate",
      reverse: false
    })
    .setClassToggle("#dinate", "loaded") // add class toggle
    .addTo(controller);

    new ScrollMagic.Scene({
      triggerElement: "#disaster",
      reverse: false
    })
    .setClassToggle("#disaster", "loaded") // add class toggle
    .addTo(controller);
